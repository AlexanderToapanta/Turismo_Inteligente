...
class ListaSitiosView extends StatefulWidget {
  const ListaSitiosView({super.key});

  @override
  State<ListaSitiosView> createState() => _ListaSitiosViewState();
}

class _ListaSitiosViewState extends State<ListaSitiosView> {
          ...
          children: [
            ...
            Padding(
              ...
              child: TextField(
                ...
                onChanged: (value) => viewModel.buscarSitio(value),
                style: GoogleFonts.poppins(color: Colors.white, fontSize: 14),
                decoration: InputDecoration(
                  hintText: 'Buscar lugares...',
                  hintStyle: GoogleFonts.poppins(color: Colors.white54),
                  prefixIcon: const Icon(Icons.search, color: TemaPersona5.primaryColor),
                  suffixIcon: _searchController.text.isNotEmpty
                      ? IconButton(
                          icon: const Icon(Icons.clear, color: Colors.white54),
                          onPressed: () {
                            _searchController.clear();
                            viewModel.buscarSitio('');
                          },
                        )
                      : null,
                  filled: true,
                  fillColor: TemaPersona5.surfaceColor,
            ...
            Expanded(
              child: _buildContent(viewModel, isAdmin),
            ),
          ],
        );
      },
  ...
  Widget _buildContent(TurismoViewModel viewModel, bool isAdmin) {
    ...
    if (viewModel.sitiosFiltrados.isEmpty) {
      return Center(
        child: Padding(
          padding: const EdgeInsets.all(24.0),
          child: Column(
    ...
    return Stack(
      children: [
        RefreshIndicator(
          onRefresh: () => viewModel.refrescarLugares(),
          color: TemaPersona5.primaryColor,
